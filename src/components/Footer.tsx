...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="fixed bottom-0 left-0 right-0 w-full bg-[#000414] border-t border-[#252525] rounded-t-xl z-50">
      <div className="max-w-md mx-auto px-8 py-4">
        <div className="flex justify-around items-center">
          ...
          >
            ...
            <span className={`${pathname === '/' ? 'text-[#FFFBC0]' : 'text-[#6C6C6C]'} group-hover:text-[#FFFBC0] transition-colors`}>
              홈
            </span>
          </div>
          ...
          >
            ...
            <span className={`${pathname === '/chat' ? 'text-[#FFFBC0]' : 'text-[#6C6C6C]'} group-hover:text-[#FFFBC0] transition-colors`}>
              대화
            </span>
          </div>
          ...
          >
            <div className="w-8 h-8 flex items-center justify-center">
              <ProfileIcon className={`${pathname === '/mypage' ? 'text-[#FFFBC0]' : 'text-[#6C6C6C]'} group-hover:text-[#FFFBC0] transition-colors`} />
            </div>
